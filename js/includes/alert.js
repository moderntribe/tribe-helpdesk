...
addAlert( `
	<div id="tribe-marketing-alert">
		<div class="tribe-marketing-alert__content">
			<p><span class="emoji">⚠️ Heads up!</span>
			Please note, the whole team is out this week for our annual team trip where we discuss how we can provide better products, services, and support for our clients. 
			Due to this our response times in the Help Desk will be slower than usual. 
			Thanks for your kind patience in advance during this time!</p>
		</div>
	</div>
` );
