...
function(e){});
            ...
            <title>Removing the add-on upsell</title>        <meta name="keywords" content="The Events Calendar,Snippet,Intermediate,Backend Tweaks,Dashboard, uitribe" />    <meta property="og:url" content="//support.theeventscalendar.com/289442-Removing-the-add-on-upsell" />    <meta property="og:title" content="Removing the add-on upsell" />    <meta property="og:description" content="You may have noticed a little bit of text trying to sell you additional functionality after you installed The Events Calendar plugin. No, that&#039;s not a used car salesman trying to trick you into buying" />    <meta property="og:type" content="article" />    <meta property="og:image" content="/scripts/file.php%3Fview=Y&file=7ac92ed24735aaa35e80b7775041b38b" />        <link rel="icon" type="image/x-icon" href="https://theeventscalendar.com/content/uploads/2015/04/favicon.ico">
  ...
  <div class="container inner-margin-top">
    <div class="row">
      <div class="col-md-12 col-sm-12" style="text-align:center">
        <h1 class="inner-header" itemprop="name">Removing the add-on upsell</h1>
        <meta itemprop="author" content="The Events Calendar">
		<meta itemprop="headline" content="Removing the add-on upsell">   
		<meta itemscope itemprop="mainEntityOfPage" itemType="https://schema.org/WebPage" itemid="//support.theeventscalendar.com/289442-Removing-the-add-on-upsell?source=tri.be?source=tri.be"/>                  
...
<p class="breadcrumbs" itemscope itemtype="https://schema.org/BreadcrumbList">
		...
		<span itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
		<span itemprop="item">
			<span itemprop="name">Removing the add-on upsell</span>
			<meta itemprop="position" content="3" />
							<link itemprop="url" href="289442-Removing-the-add-on-upsell" />
					</span>
	</span>
</p>      </div>
    </div>
...
<p>You may have noticed a little bit of text trying to&nbsp;sell you additional functionality after you installed The Events Calendar plugin. No, that's not a used car salesman trying to trick you into buying a jalopy. That's just us reminding you that more calendar features can be unlocked by purchasing add ons to the plugin.</p>

<p>We've found this to be a helpful way of letting people like you know how to get more out of the plugin. At the same time, we understand how that text can feel like it's getting in the way of doing what's most important: creating and managing events!</p>

<p>The content appears in two places:</p>
...
<p>It's actually pretty simple to remove the messages. In fact, it only takes one line of code to remove both of them. Add the following line to your site's <a href="http://codex.wordpress.org/Editing_wp-config.php" target="_blank">wp-config.php file</a>, which is located at the root of your WordPress installation:</p>

<p><code>define('TRIBE_HIDE_UPSELL', true);</code></p>

<p>You'll probably see a few other lines in that file that start with "define." You can place this snippet below the last one and it should work nicely.</p></div>    			
				<div class="Files">
...
<script type="text/javascript">
    ...
    scriptTag.setAttribute("src", "/track.php%3Fid=285&searchId="+searchId);
